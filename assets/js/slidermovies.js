...
const sliderMovies = document.querySelector('.movie-container__items');
...
(() => {
	...
	sliderMovies.addEventListener('touchstart', startMovies);

	sliderMovies.addEventListener('mousemove', moveMovies);
	sliderMovies.addEventListener('touchmove', moveMovies);
